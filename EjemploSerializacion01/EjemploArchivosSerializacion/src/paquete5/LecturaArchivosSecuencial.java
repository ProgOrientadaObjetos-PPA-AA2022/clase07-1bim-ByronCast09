...
public class LecturaArchivosSecuencial {
    ...
    private Hospital hopitalBuscado;
        ...
        if (f.exists()) {
            ...
            while (true) {
                try {
                    ...
                    if(registro.obtenerIdhospital().equals(ident)){
                        hopitalBuscado = registro;
                        break;
                    }
    ...
    public Hospital obtenerHospitalbuscado() {
        return hopitalBuscado;
    }

    @Override
    public String toString() {
        String cadena = "Informacion de Hospitales\n";
